...
<head>
  ...
  <!-- Optional: if you already load fonts globally, remove this -->
...
<body>
  ...
  <main class="help">
    ...
    <aside class="help-nav" aria-label="Help navigation">
      ...
      <div class="help-nav__role">
        ...
        <p class="help-nav__hint">
          Choose a role to hide irrelevant actions.
        </p>
      </div>
      ...
      <article id="login" class="help-section card" data-title="login">
        ...
        <div class="media">
          <figure class="shot">
            ...
            <!-- optional markers (positioned by CSS) -->
  ...
  <script>
    ...
    const roleBtns = document.querySelectorAll('.segmented__btn');
    ...
    // Simple search: filters sections by data-title text
    ...
    // Active link highlight on scroll (basic)
    const links = document.querySelectorAll('.help-link');
